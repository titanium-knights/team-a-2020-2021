...
@Autonomous(name = "RWDoItAll")
public class RWDoItAll extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory deliverA1 = drive.trajectoryBuilder(startPose, false)
                .lineToConstantHeading(new Vector2d(-2.0, -66.5))
        ...
        Trajectory shootA = drive.trajectoryBuilder(deliverA1.end(), false)
                ...
                .splineToConstantHeading(new Vector2d(-10.0, -42.0), Math.toRadians(180.0))
                ...
                .build();
        Trajectory runWobbleA = drive.trajectoryBuilder(shootA.end(), false)
                .splineToConstantHeading(new Vector2d(-30.0, -24.0), Math.toRadians(180.0))
                ...
                .build();
        Trajectory wobbleSlowA = drive.trajectoryBuilder((runWobbleA.end().plus(new Pose2d(0, 0, Math.toRadians(180)))), false)
                .back(8,
                ...
                .build();
        Trajectory deliverA2 = drive.trajectoryBuilder((wobbleSlowA.end().plus(new Pose2d(0, 0, Math.toRadians(180)))), true)
                .splineToConstantHeading(new Vector2d(-24.0, -56.0), Math.toRadians(0.0))
                .splineToConstantHeading(new Vector2d(-10.0, -64.0), Math.toRadians(180.0))
                ...
                .build();
        Trajectory parkA = drive.trajectoryBuilder((deliverA2.end()), true)
                .splineToConstantHeading(new Vector2d(-18.0, -60.5), Math.toRadians(180.0))
        ...
        Trajectory deliverB1 = drive.trajectoryBuilder((startPose), false)
                ...
                .splineToConstantHeading(new Vector2d(13.0, -41.0), Math.toRadians(180.0))
                    .addDisplacementMarker(80, () -> {
                        wobbleGoal.release(); })
                .build();
        Trajectory shootB = drive.trajectoryBuilder((deliverB1.end()), false)
                .splineToConstantHeading(new Vector2d(-10, -42.0), Math.toRadians(180.0))
                    .addDisplacementMarker( 8, () -> {
                        wobbleGoal.liftArm();
                        wobbleGoal.grab();
                        shooterMotor.setPower(0.9);
        ...
        Trajectory intakeB = drive.trajectoryBuilder((shootB.end()), false)
                .splineToConstantHeading(new Vector2d(-24.0, -36.0), Math.toRadians(0.0))
                    .addDisplacementMarker(1, () -> {
                        ...
                        shooterMotor2.setPower(0);
                        intake.togglePower();})
                .splineToConstantHeading(new Vector2d(-10, -42.0), Math.toRadians(0.0), //6
                    ...
                    .addDisplacementMarker(20, () -> {
                        ...
                        shooterMotor2.setPower(0.9);})
                .build();
        Trajectory runWobbleB = drive.trajectoryBuilder((intakeB.end()), false)
                .splineToConstantHeading(new Vector2d(-30.0, -27.0), Math.toRadians(180.0))
                    .addDisplacementMarker( () -> {
                        shooterMotor.setPower(0);
                        shooterMotor2.setPower(0);
                        wobbleGoal.lowerArm();
                        wobbleGoal.release();})
                .build();
        Trajectory wobbleSlowB = drive.trajectoryBuilder((runWobbleB.end().plus(new Pose2d(0, 0, Math.toRadians(178)))), false)
                .back(8, //6
                        new MinVelocityConstraint(Arrays.asList(
                            new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
                            new MecanumVelocityConstraint(0.1 * DriveConstants.MAX_VEL, DriveConstants.TRACK_WIDTH))),
                        new ProfileAccelerationConstraint(DriveConstants.MAX_ACCEL))
                    .addDisplacementMarker( () -> {
                        wobbleGoal.grab();})
                .build();
        Trajectory deliverB2 = drive.trajectoryBuilder((wobbleSlowB.end().plus(new Pose2d(0, 0, Math.toRadians(180)))), false)
                .splineToConstantHeading(new Vector2d(-5.0, -41.0), Math.toRadians(0.0))
                .splineToConstantHeading(new Vector2d(14.0, -41.0), Math.toRadians(0.0))
                .build();
        ...
        Trajectory deliverC1 = drive.trajectoryBuilder(startPose, false)
                .lineToConstantHeading(new Vector2d(44,-62.5))
                    .addDisplacementMarker( () -> {
                        wobbleGoal.release();})
                .build();
        Trajectory shootC = drive.trajectoryBuilder(deliverC1.end(), false)
                .splineToLinearHeading(new Pose2d(-9.3, -42.0, Math.toRadians(179.0)), Math.toRadians(180.0))
                .addDisplacementMarker( 8, () -> {
                    wobbleGoal.liftArm();
                    wobbleGoal.grab();
                    shooterMotor.setPower(0.9);
        ...
        Trajectory intakeC1 = drive.trajectoryBuilder((shootC.end()), false)
                .splineToConstantHeading(new Vector2d(-17.0, -36.0), Math.toRadians(180.0), //
                        new MinVelocityConstraint(Arrays.asList(
                            ...
                            new MecanumVelocityConstraint(0.2 * DriveConstants.MAX_VEL, DriveConstants.TRACK_WIDTH))),
                        new ProfileAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .splineToConstantHeading(new Vector2d(-7.5, -43.0), Math.toRadians(180.0))
        ...
        Trajectory intakeC2 = drive.trajectoryBuilder((intakeC1.end()), false)
                .splineToConstantHeading(new Vector2d(-32.0, -36.0), Math.toRadians(180.0),
                    ...
                    .addDisplacementMarker(1, () -> {
                        ...
                        shooterMotor2.setPower(0);
                        intake.togglePower();})
                .splineToConstantHeading(new Vector2d(-7.5, -42.0), Math.toRadians(180.0))
                    .addDisplacementMarker(48, () -> {
                        shooterMotor.setPower(0.9);
                        shooterMotor2.setPower(0.9);})
                .build();
        Trajectory runWobbleC = drive.trajectoryBuilder((intakeC2.end()), false)
                .splineToLinearHeading(new Pose2d(-30.0, -26.0, Math.toRadians(0)), Math.toRadians(180.0))
                    .addDisplacementMarker(8, () -> {
                        shooterMotor.setPower(0);
                        shooterMotor2.setPower(0);
                        wobbleGoal.lowerArm();
        ...
        Trajectory wobbleSlowC = drive.trajectoryBuilder((runWobbleC.end()), false)
                .back(9, //6
                        ...
                        new ProfileAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        Trajectory deliverC2 = drive.trajectoryBuilder((wobbleSlowC.end().plus(new Pose2d(0, 0, Math.toRadians(180)))), false)
                .splineToConstantHeading(new Vector2d(42.0, -72), Math.toRadians(180.0))
                    .addDisplacementMarker( () -> {
                        wobbleGoal.release();})
                .splineToConstantHeading(new Vector2d(8.0, -60.5), Math.toRadians(180.0))
                .build();
