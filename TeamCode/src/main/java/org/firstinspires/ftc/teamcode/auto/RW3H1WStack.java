...
@Autonomous(name = "RW3H1WStack")
public class RW3H1WStack extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory parkA = drive.trajectoryBuilder((shootA.end()), true)
                .splineToConstantHeading(new Vector2d(6.0, -48.0), Math.toRadians(0.0))
                .build();
        ...
        Trajectory intakeB = drive.trajectoryBuilder((shootB.end()), false)
                ...
                .addDisplacementMarker(1, () -> {
                    ...
                    intake.togglePower();})
                .splineToConstantHeading(new Vector2d(-9, -42.0), Math.toRadians(0.0), //6
                ...
                .addDisplacementMarker(20, () -> {
                    ...
                    shooterMotor2.setPower(0.9);})
                .build();
        Trajectory parkB = drive.trajectoryBuilder((intakeB.end()), false)
