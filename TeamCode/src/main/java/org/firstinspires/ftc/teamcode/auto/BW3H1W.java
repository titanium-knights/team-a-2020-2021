...
@Autonomous(name = "BW3H1W")
public class BW3H1W extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d startPose = new Pose2d (-64, 60, Math.toRadians(180)); //56
        ...
        Trajectory shootA = drive.trajectoryBuilder(deliverA.end(), false)
                .splineToLinearHeading(new Pose2d(-6, 58.0, Math.toRadians(162.0)), Math.toRadians(180.0))
        ...
        Trajectory deliverB = drive.trajectoryBuilder((startPose), false)
                ...
                .splineToSplineHeading(new Pose2d(24.0, 48.0, Math.toRadians(135)), Math.toRadians(0.0))
                .build();
        Trajectory shootB = drive.trajectoryBuilder((deliverB.end()), false)
                .splineToLinearHeading(new Pose2d(-7, 58.0, Math.toRadians(166.0)), Math.toRadians(180.0))
                .addDisplacementMarker( 8, () -> {
                    shooterMotor.setPower(0.9);
                    shooterMotor2.setPower(0.9);
                    wobbleGoal.liftArm();
        ...
        Trajectory deliverC = drive.trajectoryBuilder(startPose, false)
                .lineToConstantHeading(new Vector2d(46.0, 60))
                .build();
        Trajectory shootC = drive.trajectoryBuilder(deliverC.end(), false)
                .splineToLinearHeading(new Pose2d(-7, 58.0, Math.toRadians(165.0)), Math.toRadians(180.0))
