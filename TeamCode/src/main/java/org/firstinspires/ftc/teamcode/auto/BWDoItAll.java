...
@Autonomous(name = "BWDoItAll")
public class BWDoItAll extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory runWobbleA = drive.trajectoryBuilder(shootA.end(), false)
                .splineToConstantHeading(new Vector2d(-30.0, 23.0), Math.toRadians(180.0))
        ...
        Trajectory deliverA2 = drive.trajectoryBuilder((wobbleSlowA.end().plus(new Pose2d(0, 0, Math.toRadians(180)))), true)
                ...
                .splineToConstantHeading(new Vector2d(-10.0, 60.0), Math.toRadians(180.0))
        ...
        Trajectory deliverB2 = drive.trajectoryBuilder((wobbleSlowB.end().plus(new Pose2d(0, 0, Math.toRadians(180)))), false)
                .splineToConstantHeading(new Vector2d(-5.0, 34.0), Math.toRadians(0.0))
                .splineToConstantHeading(new Vector2d(14.0, 34.0), Math.toRadians(0.0))
                .build();
        ...
        Trajectory runWobbleC = drive.trajectoryBuilder((intakeC2.end()), false)
                .splineToLinearHeading(new Pose2d(-30.0, 23.5, Math.toRadians(0)), Math.toRadians(180.0))
                    .addDisplacementMarker(8, () -> {
                        shooterMotor.setPower(0);
                        shooterMotor2.setPower(0);
                        wobbleGoal.lowerArm();
        ...
        Trajectory deliverC2 = drive.trajectoryBuilder((wobbleSlowC.end().plus(new Pose2d(0, 0, Math.toRadians(180)))), false)
                .splineToConstantHeading(new Vector2d(42.0, 68), Math.toRadians(180.0))
                    .addDisplacementMarker( () -> {
                        wobbleGoal.release();})
