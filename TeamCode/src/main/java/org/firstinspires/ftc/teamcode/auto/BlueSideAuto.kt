...
@Autonomous
class BlueSideAuto: LinearOpMode() {
    override fun runOpMode() {
        ...
        when (box) {
            0 -> {
                trajectory = drive.trajectoryBuilder(shootTrajectory.end(), toRadians(-90.0))
                        .splineToConstantHeading(Vector2d(-40.0, 57.0), toRadians(0.0))
                        .splineToConstantHeading(Vector2d(38.0, 57.0), toRadians(0.0))
                        .build()
            ...
            1 -> {
                trajectory = drive.trajectoryBuilder(shootTrajectory.end(), toRadians(-90.0))
                        ...
                        .splineToConstantHeading(Vector2d(13.0, 35.0), toRadians(90.0))
                        .build()
                drive.followTrajectory(trajectory)
            }
            2 -> {
        ...
        val parkTrajectory = drive.trajectoryBuilder(trajectory.end(), toRadians(-90.0))
                .splineToConstantHeading(Vector2d(3.0, 60.0), toRadians(0.0))
                .build()
