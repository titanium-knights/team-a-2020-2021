...
@Autonomous(name = "BF3PS1WStack")
public class BF3PS1WStack extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory deliverB = drive.trajectoryBuilder(shootPS.end(), false)
                .splineToLinearHeading(new Pose2d(32.0, 24.0, Math.toRadians(90.0)), Math.toRadians(-90.0))
                .build();
        ...
        Trajectory intakeB = drive.trajectoryBuilder(deliverB.end(), false)
                .splineToSplineHeading(new Pose2d(32, 36.0, Math.toRadians(90.0)), Math.toRadians(90.0))
                .splineToSplineHeading(new Pose2d(12.0, 36.0, Math.toRadians(180.0)), Math.toRadians(180.0))
                .splineToSplineHeading(new Pose2d(-24.0, 32.0, Math.toRadians(180.0)), Math.toRadians(180.0))
                .build();
        Trajectory intakeC = drive.trajectoryBuilder(deliverC.end(), false)
                .splineToSplineHeading(new Pose2d(30.0, 36.0, Math.toRadians(180.0)), Math.toRadians(90.0))
        ...
        Trajectory shoot1 = drive.trajectoryBuilder(intakeB.end(), false)
                .splineToSplineHeading(new Pose2d(-8.0, 33.0, Math.toRadians(178.0)), Math.toRadians(0.0))
                .build();
        ...
        flap.setPosition(0.033); //High goal: 0.00      PS: 0.05
        sleep(1000);
        shooterServo.setPosition(12);
        sleep(400);
        shooterServo.setPosition(0);
        drive.turn(Math.toRadians(9));
        flap.setPosition(0.038);
        sleep(600);
        shooterServo.setPosition(12);
        sleep(400);
        shooterServo.setPosition(0);
