...
@Autonomous(name = "RF3PS1W")
public class RF3PS1W extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory shootBB = drive.trajectoryBuilder(intakeBB.end(), false)
                .splineToSplineHeading(new Pose2d(-6.0, -12.0, Math.toRadians(162.0)), Math.toRadians(180.0))
                .build();
        ...
        Trajectory parkB = drive.trajectoryBuilder(deliverB.end(), false)
                .lineToConstantHeading(new Vector2d(36.0, -12.0))
                .splineToConstantHeading(new Vector2d(12.0, -12.0), Math.toRadians(0.0))
                .build();
        Trajectory parkC = drive.trajectoryBuilder(deliverC.end(), false)
                .splineToSplineHeading(new Pose2d(53.0, -12.0, Math.toRadians(90)), Math.toRadians(0.0))
